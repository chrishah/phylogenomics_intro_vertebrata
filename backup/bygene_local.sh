...
do
        ...
        singularity exec ~/Share/Singularity_images/clustalo-docker_1.2.4.sif clustalo -i by_gene/raw/${gene}_all.fas -o by_gene/aligned/${gene}.clustalo.fasta --threads=2
        ...
        singularity exec ~/Share/Singularity_images/iqtree_2.0.7.sif \
              iqtree \
